#!/usr/bin/env python3
"""
🎯 ELIMINAÇÃO COMPLETA DO ESTILO ROXO
===================================== 
Remove TODOS os imports de biodesk_dialogs (roxo) e converte para biodesk_styled_dialogs (cinza)
"""
...
def fix_file_completely(filepath):
    ...
    try:
        ...
        if ('mostrar_' in content or 'BiodeskMessageBox' in content) and 'from biodesk_styled_dialogs import BiodeskMessageBox' not in content:
